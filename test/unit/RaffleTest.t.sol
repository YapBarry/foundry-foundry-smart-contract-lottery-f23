...
contract RaffleTestis is CodeConstants, Test {
    ...
    function testPerformUpkeepCanOnlyRunIfCheckUpkeepIsTrue() public {
        ...
        // Act / Assert
        raffle.performUpkeep(""); // if this fails, the entire test will fail
    }
        ...
        skipFork
    {
        ...
        uint256 winnerStartingBlance = expectedWinner.balance;
        ...
        assert(uint256(raffleState) == 0); // that it's back to open state
        assert(winnerBalance == winnerStartingBlance + prize);
